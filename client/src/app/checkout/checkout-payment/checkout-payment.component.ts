...
export class CheckoutPaymentComponent implements OnInit{
  ...
  ngOnInit(): void {
    loadStripe('pk_test_51NG0zQILQqKzmTjaXLWFBN2sqnTtjyKrtx7396IuQ8VxbelQwsEYdqBxJfQdFAzWme9zYHIabZf3N6We2KkgPPoi00QBs3t4ie').then(stripe => {
      this.stripe = stripe;
  ...
  async submitOrder() {
    ...
    if (!basket) throw new Error('Can not get the basket!')
    try {
